        ...
        <div className="max-w-7xl mx-auto space-y-10">
          ...
          <div className="bg-white border border-gray-200 p-4 rounded-2xl flex flex-col sm:flex-row gap-4 shadow-sm relative z-20">
            ...
            <select
              ...
              className="bg-gray-50 border border-gray-200 text-gray-700 rounded-xl px-6 py-3 outline-none focus:bg-white focus:border-blue-900 focus:ring-2 focus:ring-blue-100 transition-all cursor-pointer min-w-[200px] font-bold"
            >
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 flex justify-between items-start mb-4">
                    ...
                    <button 
                      onClick={() => {
                        if(window.confirm(`¿Seguro que deseas eliminar el grupo ${g.nombre}?`)) {
                           deleteGrupo(g._id);
                        }
                      }} 
